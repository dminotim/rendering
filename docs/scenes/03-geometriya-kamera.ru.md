...
## 3.5a. Развлечение: пол в клетку и производные
...
камеры. Причина ровно та же, что у муара на текстуре без мипов (о нём в главе 4): один пиксель
...
пиксель, и растянуть переход на эту величину. В главе 9 мы применим ровно эту логику к порогу
альфа-маски.
...
сценах архива из главы 12 по нему сразу видно, где треугольники мельче пикселя — то самое место,
