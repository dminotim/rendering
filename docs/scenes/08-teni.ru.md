...
## 8.8b. Пять ошибок, которые эта глава стоила на практике
...
| **Тени видны в отладочной выгрузке, но не в окне** | Пути рендеринга разошлись — раздел 8.8b.0 |
...
9. **Выгружайте карту теней в файл.** Это первый шаг отладки, а не последний: три из пяти ошибок
   раздела 8.8b иначе не находились.
